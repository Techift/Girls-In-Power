...
function Volunteer() {
  return (
    <>
      ...
      >
        <div
          className="volunteer_passion"
          style={{
            background: "rgb(241, 6, 84)",
            marginBottom: "2rem",
            padding: "1rem 1rem",
            borderRadius: "20px",
            color: "white",
        ...
        <div
          className="volunteer_roles"
          style={{
            background: "rgb(12, 82, 14)",
            marginBottom: "2rem",
            padding: "1rem 2rem",
            borderRadius: "20px",
            color: "white",
        ...
        >
          <ul style={{ listStyle: "none" }}>
            ...
            <li>4. Bootcamp Support (Tech, Skills, Workshops)</li>
          </ul>
        </div>
      </div>

      <div
        className="teer_contact"
        style={{ textAlign: "center", padding: "2rem 0" }}
      >
        <h2>Ready to make a difference?</h2>
        <p style={{ fontSize: "1.2rem", marginBottom: "2rem" }}>
          Fill out our volunteer form and we'll connect you to a role that fits
      ...
      >
        "Together, let’s build a world where every girl knows her power."
      </p>
    </>
  );
}
